...
class Wechat
{
	...
	public function __construct($options = array())
	{
		...
		$this->token = $config['token'];//$this->token = isset($options['token'])?$options['token']:'';
		$this->encodingAesKey = isset($options['encodingaeskey'])?$options['encodingaeskey']:'';
		$this->appid = $config['appid'];//$this->appid = isset($options['appid'])?$options['appid']:'';
		$this->appsecret = $config['appsecret'];//$this->appsecret = isset($options['appsecret'])?$options['appsecret']:'';
